...
public class FrmCliente extends javax.swing.JInternalFrame {
    ...
    public void alteraCliente(){
        if(jTxtNome.getText().trim().equals("")){
            JOptionPane.showMessageDialog(this, "Inform o nome do cliente","Erro",JOptionPane.ERROR_MESSAGE);
            jTxtNome.requestFocus();
        }else{
            Cliente cliente = new Cliente();
    ...
    private void excluirCliente(){
        ...
        if(clienteDAO.excluirCliente(lista.get(jTblClientes.getSelectedRow()))){
            JOptionPane.showMessageDialog(this, "Dados do cliente excluidos com sucesso", "Confirmação", JOptionPane.INFORMATION_MESSAGE);
            listar();
        }else{
            JOptionPane.showMessageDialog(this, "Erro ao excluir os dado!", "Erro", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void jBtnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnExcluirActionPerformed
        if(jTblClientes.getSelectedRow() != -1){
            int resposta = JOptionPane.showConfirmDialog(this, "Confirma a excluisao de cliente? ", "Confirmação", JOptionPane.YES_NO_OPTION);
